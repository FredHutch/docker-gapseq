...
RUN apt-get update
RUN DEBIAN_FRONTEND=noninteractive apt-get install -y ncbi-blast+ git libglpk-dev r-base-core exonerate bedtools barrnap bc parallel libcurl4-openssl-dev libssl-dev locales locales-all wget
